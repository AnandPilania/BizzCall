...
public class IVRMissedTollFree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ivrmissed_toll_free);
        try {
            requestQueue= Volley.newRequestQueue(IVRMissedTollFree.this);
        ...
        {
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-226 OnlineLead onCreate "+e.toString(),Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        try{
            Intent intent = new Intent(IVRMissedTollFree.this, Home.class);
            intent.putExtra("Activity", "IVRMissed");
            //intent.putExtra("MainMenu",MainMenuselected);
            startActivity(intent);
        }catch (Exception e)
        {
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-233 OnlineLead onBackPressed "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
    public void loadOnlineLead()
    {
        try {
            if (CheckInternetSpeed.checkInternet(IVRMissedTollFree.this).contains("0")) {
                android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(IVRMissedTollFree.this);
            ...
            } else if (CheckInternetSpeed.checkInternet(IVRMissedTollFree.this).contains("1")) {
                android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(IVRMissedTollFree.this);
                ...
                dialog = ProgressDialog.show(IVRMissedTollFree.this, "", "Loading IVR Missed Entry", true);
                caseid="94";
                editor.putString("ActOnlineLead", "IVRMissed");
                editor.commit();
                if (actname.contains("RefreshIVRMissed")  || actname.contains("ContactIVRMissed")) {
        ...
        {
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-227 OnlineLead loadOnlineLead "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
    public void btnNextClicked()
    {
        try {
            ...
            if (CheckInternetSpeed.checkInternet(IVRMissedTollFree.this).contains("0")) {
                ...
                editor.putString("MaxVal", txtMax.getText().toString());
                editor.commit();
                dialog = ProgressDialog.show(IVRMissedTollFree.this, "", "Loading online leads", true);
                getOnlineLead(caseid, strMin, strMax);
            }
            txtDisplayInfo.setText("Displaying " + txtMin.getText().toString() + "-" + txtMax.getText().toString());
        }catch (Exception e)
        {
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-228 OnlineLead btnNextClicked "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
    public void btnPreviousClicked()
    {
        ...
        {
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-229 OnlineLead btnPreviousClicked "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
    public void refreshClicked()
    {
        try {
            ...
            editor.putString("MaxVal", txtMax.getText().toString());
            editor.commit();
            Intent intent = new Intent(IVRMissedTollFree.this, OnlineLead.class);
            if (actname.equals("IVRMissed")) {
        ...
        {
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-230 OnlineLead btnPreviousClicked "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
    ...
    {
        try{
            if(CheckServer.isServerReachable(IVRMissedTollFree.this)) {
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    adapterOnlineLead = new AdapterOnlineLead(IVRMissedTollFree.this, arrayListOnlineLead);
                                    ...
                                    Toast.makeText(IVRMissedTollFree.this, "Errorcode-232 OnlineLead OnlineLeadResponse " + e.toString(), Toast.LENGTH_SHORT).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                if (error.networkResponse != null || error.networkResponse.equals("TimeoutError") || error instanceof NoConnectionError || error instanceof AuthFailureError || error instanceof ServerError || error instanceof NetworkError || error instanceof ParseError) {
                                    ...
                                    dialog.dismiss();
                                    Toast.makeText(IVRMissedTollFree.this, "Server Error", Toast.LENGTH_SHORT).show();
                                    // showCustomPopupMenu();
        ...
        }catch (Exception e)
        {
            ...
            Toast.makeText(IVRMissedTollFree.this,"Errorcode-231 OnlineLead getOnlineLead "+e.toString(),Toast.LENGTH_SHORT).show();            }
    }
}
