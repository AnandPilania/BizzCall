...
public class AdapterCategorywiseInward extends RecyclerView.Adapter<AdapterCategorywiseInward.MyHolder> {
    Context context;
    ArrayList<DataCategorywiseExpenses> arrayListCategorywise;
    DataCategorywiseExpenses dataCategorywiseExpenses;

    public AdapterCategorywiseInward(Context context, ArrayList<DataCategorywiseExpenses> arrayListCategorywise) {
    ...
    @NonNull
    @Override
    public AdapterCategorywiseInward.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
