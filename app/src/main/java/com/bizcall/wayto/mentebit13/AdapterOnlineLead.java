...
public class AdapterOnlineLead extends RecyclerView.Adapter<AdapterOnlineLead.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final AdapterOnlineLead.ViewHolder viewHolder, final int i)
    {
        ...
        if(actname.equals("OpenLeads"))
        {
            viewHolder.txtCourse.setText(dataCounselor.getRemarks());
        }
        else {
        ...
        if(actname.equals("ConvertedOnlineLead")||actname.equals("IVRMissed"))
        {
        ...
        viewHolder.imgRemove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(actname.equals("OpenLeads")) {
                    Selectedsrno = viewHolder.txtSrno.getText().toString();
                    clicked = "Remove";
                    urlSatatus = clienturl + "?clientid=" + clientid + "&caseid=181&SrNo=" + Selectedsrno;
                    dialog = ProgressDialog.show(context, "", "Updating Open Lead", false, true);
                    updateOnlineLead(urlSatatus);
                }
                else if(actname.equals("OnlineLead"))
                {
                    Selectedsrno = viewHolder.txtSrno.getText().toString();
                    clicked = "Remove";
                    String urlSatatus = clienturl + "?clientid=" + clientid + "&caseid=66&RefNo=" + Selectedsrno;
    ...
    public void updateOnlineLead(final String urlSatatus)
    {
        try {
            if(CheckServer.isServerReachable(context)) {
                requestQueue = Volley.newRequestQueue(context);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView txtSrno, txtCName, txtCourse, txtCount1, txtMobile, txtStatus,txtParent,txtDate;
