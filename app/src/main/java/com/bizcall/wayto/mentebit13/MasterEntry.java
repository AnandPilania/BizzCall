  ...
  String strFileId="",strSrNo="",strAllocatedTo="",strFname="", strLname="",strDob="",searchAs="",result="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //to initialize all controls and varialbles
           initialize();
            ...
            btnAllDetails.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (CheckInternetSpeed.checkInternet(MasterEntry.this).contains("0")) {
                        ...
                        //to get all details of leads whose file number is generated
                        getAllDetails();
                    }
                }
            });
                    ...
                    if (searchAs.contains("Select")) {
                        ...
                        if (CheckInternetSpeed.checkInternet(MasterEntry.this).contains("0")) {
                            ...
                            if(searchtext.length()!=0) {
                                ...
                                newThreadInitilization(dialog);
                                //to search specific lead whose file number is generated
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(dialog1.isShowing()) {
                                dialog1.dismiss();
                                Toast.makeText(MasterEntry.this, "Connection Aborted", Toast.LENGTH_SHORT).show();
                            }
...
public void initialize()
{
    ...
    public void searchDetails(String searchtext)
    {
        try {
            arrayListMasterEntry = new ArrayList<>();
            url = clienturl + "?clientid=" + clientid + "&caseid=79&SearchAs=" + searchAs + "&SearchVal=" + searchtext + "&CounselorID=" + counselorid+"&Step=1";
    ...
    public void getAllDetails()
    {
        try {
            arrayListMasterEntry = new ArrayList<>();
            url = clienturl + "?clientid=" + clientid + "&caseid=78&CounselorID=" + counselorid+"&Step=1";
