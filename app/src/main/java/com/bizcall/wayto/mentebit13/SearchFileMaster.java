...
public class SearchFileMaster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // imgBack = findViewById(R.id.img_back);
        ...
        requestQueue = Volley.newRequestQueue(SearchFileMaster.this);
        // arrayListMasterEntry = new ArrayList<>();

        ArrayAdapter<String> mSpinnerAdapter = new ArrayAdapter<String>(SearchFileMaster.this,
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (searchAs.contains("Select")) {
                    ...
                    if (CheckInternetSpeed.checkInternet(SearchFileMaster.this).contains("0")) {
                        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(SearchFileMaster.this);
                    ...
                    } else if (CheckInternetSpeed.checkInternet(SearchFileMaster.this).contains("1")) {
                        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(SearchFileMaster.this);
                        ...
                        if (searchtext.length() != 0) {
                            dialog = ProgressDialog.show(SearchFileMaster.this, "", "Searching data", true);
                            searchDetails(searchtext);
                        } else {
                            edtSearchText.setError("Enter text to searcg");
                        }
                    }
                }
            }
    ...
    {
        Toast.makeText(SearchFileMaster.this,"Errorcode-305 MasterEntry onCreate "+e.toString(),Toast.LENGTH_SHORT).show();
    }
}//onCreate

    @Override
    public void onBackPressed() {
        /*Intent intent=new Intent(SearchFileMaster.this,AddExpenses.class);
    ...
    public void searchAsItemSelected()
    {
        ...
        {
            Toast.makeText(SearchFileMaster.this,"Errorcode-306 MasterEntry searchAsItemSelected "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
    public void searchDetails(String searchtext)
    {
        try {
            ...
            if (CheckInternet.checkInternet(SearchFileMaster.this)) {
                if(CheckServer.isServerReachable(SearchFileMaster.this)) {
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if (response.contains("[]")) {
                                            ...
                                            myAdapter = new AdapterSearchFile(arrayListMasterEntry, SearchFileMaster.this);

                                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SearchFileMaster.this);
                                            linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);

                                            mRecyclerviewTabledetails.addItemDecoration(new DividerItemDecoration(SearchFileMaster.this, DividerItemDecoration.VERTICAL));
                                            mRecyclerviewTabledetails.setLayoutManager(linearLayoutManager);
                                            mRecyclerviewTabledetails.setAdapter(myAdapter);
                                        }

                                    } catch (JSONException e) {
                                        Toast.makeText(SearchFileMaster.this, "Errorcode-308 MasterEntry searchDetailsResponse " + e.toString(), Toast.LENGTH_SHORT).show();
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    if (error.networkResponse != null || error instanceof TimeoutError || error instanceof NoConnectionError || error instanceof AuthFailureError || error instanceof ServerError || error instanceof NetworkError || error instanceof ParseError) {
                                        ...
                                        dialog.dismiss();
                                        Toast.makeText(SearchFileMaster.this, "Network issue", Toast.LENGTH_SHORT).show();
                                        // showCustomPopupMenu();
        ...
        {
            Toast.makeText(SearchFileMaster.this,"Errorcode-307 MasterEntry searchDetails "+e.toString(),Toast.LENGTH_SHORT).show();
        }
    }
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    if (error.networkResponse != null || error instanceof TimeoutError || error instanceof NoConnectionError || error instanceof AuthFailureError || error instanceof ServerError || error instanceof NetworkError || error instanceof ParseError) {
                                        ...
                                        dialog.dismiss();
                                        Toast.makeText(MasterEntry.this, "Network issue", Toast.LENGTH_SHORT).show();
                                        // showCustomPopupMenu();
                                        Log.e("Volley", "Error.HTTP Status Code:" + error.networkResponse.statusCode);
                                    }
                                }
