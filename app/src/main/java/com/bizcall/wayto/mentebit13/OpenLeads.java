...
public class OpenLeads extends AppCompatActivity {
   ...
   String activity="",clienturl="",clientid="",counselorid="",name="",course="",mbl="",adrs="",city="",state1="",pincode="",
           parentno="",email="",fetchedDataFrom="",fetchedAllocatedTo="",allocatedDate="",statusid="",remark="",fetchedCreatedDate="",
           status11="";
   ...
   ImageView imgUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
           ...
           initialize();
            ...
            editor.commit();
            caseid = "75";
            //to check internet connection and call getOpenLeads function
            loadRefnames();
            imgUpdate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    dialog=ProgressDialog.show(OpenLeads.this,"","Updating leads",true);
                     ...
                     if (++check > 1) {
                         ...
                         if (CheckInternetSpeed.checkInternet(OpenLeads.this).contains("0")) {
                             ...
                             dialog = ProgressDialog.show(OpenLeads.this, "", "Loading open leads", true);
                                newThreadInitilization(dialog);
                                //to get leads from selected refnames from dropdown
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //to get next 25 leads from server
                    btnNextClicked();
                // refreshWhenLoading();
                }
            });
            btnPrevious.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //to get previous 25 leads from server
                    btnPreviousClicked();
                    // refreshWhenLoading();
    ...
    public void updateOnlineLeadNew()
    {
                        ...
                        if (response.contains("Row updated successfully")) {
                           ...
                           // if (actname.contains("OpenLeads")) {
                            ...
                            /*} else {
                                ...
                                Intent intent = new Intent(OpenLeads.this, OnlineLead.class);
                                intent.putExtra("ActivityLeads", "Refresh" + actname);
                                startActivity(intent);
                                // }
                            }*/
                            Toast.makeText(OpenLeads.this, "Open lead updated successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(OpenLeads.this, "Open lead not updated ", Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                       // Toast.makeText(OpenLeads.this, "Errorcode-405 AdapterOnlineLead updateOnlineLeadResponse", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        {
            //Toast.makeText(OpenLeads.this, "Errorcode-404 AdapterOnlineLead updateOnlineLead", Toast.LENGTH_SHORT).show();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(dialog1.isShowing()) {
                                dialog1.dismiss();
                                Toast.makeText(OpenLeads.this, "Connection Aborted", Toast.LENGTH_SHORT).show();
                            }
...
public void initialize()
{
    ...
    {
        try{
        url=clienturl+"?clientid=" + clientid + "&caseid="+caseid1+"&MinVal="+strMin1+"&MaxVal="+strMax1+"&DataRefID="+refId+"&CounselorID="+counselorid;
                            ...
                            try {
                                if (response.contains("[]") || response.contains("You are not authorized")) {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        Log.d("DateAllocation", allocatedDate);
                                        allocatedDate = allocatedDate.substring(allocatedDate.indexOf(":") + 2, 20);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            if (error.networkResponse != null || error instanceof TimeoutError || error instanceof NoConnectionError || error instanceof AuthFailureError || error instanceof ServerError || error instanceof NetworkError || error instanceof ParseError) {
                                ...
                                dialog.dismiss();
                                Toast.makeText(OpenLeads.this, "Network issue", Toast.LENGTH_SHORT).show();
                                // showCustomPopupMenu();
    ...
    public void getOpenLeadRef() {
        try {
            url = clienturl + "?clientid=" + clientid + "&caseid=74&CounselorID="+counselorid;
            arrayListOnlineLead = new ArrayList<>();
