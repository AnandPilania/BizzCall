    ...
    public void onBindViewHolder(@NonNull final UserHolder userHolder, int i) {
        ...
        userHolder.txtDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("SelectedSrNo",userHolder.txtSrno.getText().toString());
                ...
                editor.putString("City",userHolder.txtCity.getText().toString());
                editor.putString("State",userHolder.txtState.getText().toString());
                editor.putString("Pincode",userHolder.txtPincode.getText().toString());
                editor.putString("ParentNo",userHolder.txtParentNo.getText().toString());

                if(userHolder.txtAddress.getText().toString().length()==0)
                {
                    editor.putString("ClientAddress","NA");
                }
                else {
                    editor.putString("ClientAddress", userHolder.txtAddress.getText().toString());
                }
                if(userHolder.txtEmail.getText().toString().length()==0)
                {
                    editor.putString("ClientEmail","NA");
                }else {
                    editor.putString("ClientEmail", userHolder.txtEmail.getText().toString());
                }
