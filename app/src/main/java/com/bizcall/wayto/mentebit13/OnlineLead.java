...
public class OnlineLead extends AppCompatActivity {
   ...
   String clienturl="",clientid="",name="",course="",mbl="",adrs="",city="",state1="",pincode="",parentno="",email="",fetchedDataFrom="",fetchedAllocatedTo="",allocatedDate="",statusid="",remark="",fetchedCreatedDate="",status11="",sr_no="";
   ...
   String counselorid="";
   Vibrator vibrator;
   String actname="",url="",caseid="";
   SharedPreferences.Editor editor;
   TextView txtActivityName;
   ImageView imgRemove,imgUpdate;
   @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        try {
            setContentView(R.layout.activity_online_lead);
            //tp initialize all variables and controls
            initialize();
            ...
            imgRemove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialog=ProgressDialog.show(OnlineLead.this,"","Deleting leads",true);
            ...
            //to check internet connnection and call getOnline lead function
           loadOnlineLead();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(dialog1.isShowing()) {
                                dialog1.dismiss();
                                Toast.makeText(OnlineLead.this, "Connection Aborted", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
    ...
    public void updateOnlineLead()
    {
        try {
            requestQueue = Volley.newRequestQueue(OnlineLead.this);
                ...
                urlRequest.setContext(OnlineLead.this);
                        ...
                        try {
                            ...
                            if (response.contains("Row updated successfully")) {
                                ...
                                if (actname.contains("OpenLeads")) {
                                    Intent intent = new Intent(OnlineLead.this, OpenLeads.class);
                                ...
                                Toast.makeText(OnlineLead.this, "Online lead updated successfully", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(OnlineLead.this, "Online lead not updated ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (Exception e) {
                            Toast.makeText(OnlineLead.this, "Errorcode-405 AdapterOnlineLead updateOnlineLeadResponse", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        {
            Toast.makeText(OnlineLead.this, "Errorcode-404 AdapterOnlineLead updateOnlineLead", Toast.LENGTH_SHORT).show();
    ...
    public void loadOnlineLead()
    {
        try {
            if (CheckInternetSpeed.checkInternet(OnlineLead.this).contains("0")) {
                ...
                //to get online leads response from server
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    if (error.networkResponse != null || error.networkResponse.equals("TimeoutError") || error instanceof NoConnectionError || error instanceof AuthFailureError || error instanceof ServerError || error instanceof NetworkError || error instanceof ParseError) {
                                        ...
                                        dialog.dismiss();
                                       // Toast.makeText(OnlineLead.this, "Network issue", Toast.LENGTH_SHORT).show();
                                        // showCustomPopupMenu();
