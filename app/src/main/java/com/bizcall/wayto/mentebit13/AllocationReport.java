                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(dialog1.isShowing()) {
                                dialog1.dismiss();
                                Toast.makeText(AllocationReport.this, "Something is wrong, Please try again.", Toast.LENGTH_SHORT).show();
                            }
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        for (int i = 0; i < jsonArray.length(); i++) {
                                            ...
                                            String precounselor = jsonObject1.getString("Previous Counselor");

                                            String counselorname = jsonObject1.getString("New Counselor");
                                            String statusStr = jsonObject1.getString("Current Status");
                                            Log.d("Status11", srno);
                                            DataReallocation dataReallocation;
                                           if(strToBy.contains("By")) {
                                                 dataReallocation = new DataReallocation(serial, srno, cname, course, statusStr, precounselor);
                                            }
                                            else {
                                                dataReallocation = new DataReallocation(serial, srno, cname, course, statusStr, counselorname);
                                            }
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    if (error.networkResponse != null || error instanceof TimeoutError || error instanceof NoConnectionError || error instanceof AuthFailureError || error instanceof ServerError || error instanceof NetworkError || error instanceof ParseError) {
                                        ...
                                        dialog.dismiss();
                                        Toast.makeText(AllocationReport.this, "Network issue", Toast.LENGTH_SHORT).show();
                                        // showCustomPopupMenu();
