      ...
      //  }
        myHolder.linearStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String dtFrom=Dashboard.edtDatefrom.getText().toString();
                String dtTo=Dashboard.edtDateTo.getText().toString();
                if(dtFrom.length()==0)
                {
                    dtFrom="1900-01-01";
                }
                if(dtTo.length()==0)
                {
                    dtTo= ( Dashboard.year + "-" +(Dashboard.month+1)  + "-" +Dashboard.day);
                }
                ...
                editor.putString("DateFrom",dtFrom);
                editor.putString("DateTo",dtTo);
                editor.putString("CCountry","");
                editor.commit();
