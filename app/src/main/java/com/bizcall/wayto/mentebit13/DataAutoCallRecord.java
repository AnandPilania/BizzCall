...
public class DataAutoCallRecord implements Serializable {
    String leadName, leadNumber, leadType, leadRealme, leadDateCompare, leadTime, leadRecName;

    public DataAutoCallRecord(String leadName, String leadNumber, String leadType, String leadRealme, String leadDateCompare, String leadTime, String leadRecName) {
