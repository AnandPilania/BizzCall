...
public class ReminderActivity extends AppCompatActivity {
   ...
   /* class MyJSON implements Runnable {
        ...
        public void run() {
            try {
                String url = clienturl+"?clientid=" + clientid + "&caseid=33&nCounsellorId="+counsellorid;
        ...
        public void onResponse(JSONObject response) {
            ...
            try {
               ...
               /* alertHandler.post(new Runnable() {
                ...
                Toast.makeText(ReminderActivity.this,"Excetption in reminder response",Toast.LENGTH_SHORT).show();
